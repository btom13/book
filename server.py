...
def grade_questions():
    ...
    ret = []
    for d in data['data']:
        question, user_answer, paragraph = d['question'], d['user_answer'], d['paragraph']
